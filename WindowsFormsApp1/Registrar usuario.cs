        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cadena = "INSERT INTO dbo.Empleado( Nombre, Apellido,edad, usuario, codigo, Cargo) values('" + this.txtnombre.Text + "','" + this.txtapellido.Text + "'," + this.txtedad.Text + ",'" + this.txtusuario.Text + "','" + this.txtcodigo.Text + "','" + this.cargo + "')";
